...
class FaceView: UIView
{
    ...
    // not initialized
    @IBInspectable
    var color: UIColor = UIColor.blueColor() { didSet {  leftEye.color = color ; rightEye.color = color } }
    @IBInspectable
    var lineWidth: CGFloat = 5.0 { didSet { leftEye.lineWidth = lineWidth; rightEye.lineWidth = lineWidth } }
